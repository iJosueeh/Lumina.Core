...
namespace Estudiantes.Infrastructure
{
    ...
    public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            {
                // Fallback for design-time if appsettings.json is not found or connection string is empty
            ...
            return new ApplicationDbContext(builder.Options, publisher); // Pass publisher here
        }
    }
}
